...
Button(root,text='male',bg="Yellow",command=male_click).grid(row=0,column=0,ipady=20)
Button(root,text='female', bg='hot pink',command=female_click).grid(row=0,column=1,ipady=20)

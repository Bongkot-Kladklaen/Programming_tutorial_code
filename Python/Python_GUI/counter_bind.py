...
btn_male = Button(root,text='male',bg="Yellow")
btn_male.grid(row=0,column=0,ipady=20)
btn_male.bind("<Button-1>",on_click)
btn_male.bind("<Button-2>",right_click)

btn_female = Button(root,text='female', bg='hot pink')
btn_female.grid(row=0,column=1,ipady=20)
btn_female.bind("<Button-1>",on_click)
btn_female.bind("<Button-2>",right_click)
